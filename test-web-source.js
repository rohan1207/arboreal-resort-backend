/**
 * Test with Source_Id = "WEB" (Booking Engine source from eZee dashboard)
 */
...
async function testWithWebSource() {
  try {
    const bookingData = {
      "Room_Details": {
        "Room_1": {
      ...
      "Source_Id": "WEB",  // ✅ Use "WEB" instead of "" or "1"
      "MobileNo": "",
      "Address": "",
      "State": "",
      "Country": "",
    ...
    console.log('\n========================================');
    console.log('TESTING WITH Source_Id = "WEB"');
    console.log('(Booking Engine source from eZee dashboard)');
    console.log('========================================\n');
